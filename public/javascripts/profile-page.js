...
$(document).ready(function() {
    ...
    var post_url = "profile-page/"+id+"/posts";
    $.ajax({
        url: post_url,
        type: 'GET'
    ...
    $('#modal-post-content').submit(function(e) {
        ...
        //Generate post url
        var post_url = "profile-page/"+posts[calc].id+"/editpost";
    ...
    $("#delete-post").click(function() {
        ...
        //Generate delete url
        var post_url = "profile-page/"+id+"/deletePost/"+posts[calc].id;
    ...
    $('#all-posts').on('click', '.like-btn', function() { 
        ...
        //Generate post url
        var post_url = "profile-page/"+posts[calc].id+"/editlike";
    ...
    $('#all-posts').on('submit', '.comment-input-form', function(e) {
        ...
        var post_url = "profile-page/"+posts[calc].id+'/comment';
    ...
    $('#add-friend-btn').on('click', function(e) {
        ...
        var post_url = "profile-page/"+email+"/findfriend";
        $.ajax({
            url: post_url,
            type: "GET"
        }).done(function(response) {
    ...
    $('#find-friends-modal').on('click', '#add-user-btn', function(e) {
        ...
        var post_url = "profile-page/"+userid+"/addfriend";
        $.ajax({
            url: post_url,
            type: "POST",
            dataType: 'json',
